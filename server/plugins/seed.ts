...
import { dialectTree, sampleWords, type DialectSeed } from '../db/seed-data'
import { normalizeArabic } from '../../shared/utils/arabic'

/**
 * On startup: apply migrations (done inside useDb) and, if the database is
 * empty, insert the dialect tree and the sample words.
 */
