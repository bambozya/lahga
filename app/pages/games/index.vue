...
useSeo({
  title: 'ألعاب',
  description: 'ألعاب يومية من قاموس لهجة: خمّن الكلمة بالفصحى من أشكالها في اللهجات، أو خمّن اللهجة من شكل الكلمة.',
  path: '/games',
})
</script>
...
<template>
  <article>
    ...
    <dl>
      ...
      <div>
        <dt><NuxtLink to="/which-dialect">من أي لهجة؟</NuxtLink></dt>
        <dd>
