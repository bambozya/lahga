...
<template>
  <nav aria-label="الإدارة">
    <ul>
      <li><NuxtLink to="/settings/admin">البلاغات<template v-if="stats?.openFlags"> ({{ stats.openFlags }})</template></NuxtLink></li>
      ...
      <li><NuxtLink to="/settings/admin/slugs">عناوين مرقّمة</NuxtLink></li>
