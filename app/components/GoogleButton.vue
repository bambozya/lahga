...
<style scoped>
a { display: inline-flex; align-items: center; gap: var(--space-2xs); border: var(--thin); border-radius: var(--radius); padding: var(--space-2xs) var(--space-s); text-decoration: none; font-weight: 600; }
</style>
